...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Welcome To E-Library</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">E-Library is an online library where you can find books, learning resources, and also donate books.</p>
            <a href="SignUp.php" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Register
        ...
        <div class="lg:col-span-5 bg-transparent lg:mt-0">
            <img src="http://localhost/IT%20Workshop/Front-End/image/Welcome.png" alt="Welcome image" class="opacity-90">
        </div>
    </div>
</section>
...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl text-center">
        ...
        <p class="my-6 text-gray-500 dark:text-gray-400">Open-source library of Books.</p>
